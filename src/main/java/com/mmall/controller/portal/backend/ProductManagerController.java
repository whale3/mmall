...
/**
 * Created by Zhiwei on 2018/10/18.
 */
@Controller
...
public class ProductManagerController {
    ...
    //    User user = (User)session.getAttribute(Const.CURRENT_USER);
        ...
        if(user == null){
            return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(),"用户未登入,请登入管理员");
        }
    ...
    @ResponseBody
    public ServerResponse set_sale_status(HttpServletRequest httpServletRequest,Product product,Integer productId,Integer status){
    //    User user = (User)session.getAttribute(Const.CURRENT_USER);
    ...
    @ResponseBody
    public ServerResponse getDetail(HttpServletRequest httpServletRequest,Product product,Integer productId){
     //   User user = (User)session.getAttribute(Const.CURRENT_USER);
