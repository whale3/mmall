...
public class OrderController {
    ...
    @ResponseBody
    public ServerResponse pay(HttpServletRequest httpServletRequest, Long orderNo, HttpServletRequest requset){
    //    User user = (User)session.getAttribute(Const.CURRENT_USER);
    ...
    public ServerResponse<String> alipayCallback(HttpServletRequest request){
        ...
        if(serverResponse.isSuccess()){
            return ServerResponse.createByErrorMessage(Const.AlipayCallback.RESPONSE_SUCCESS);
        }
    ...
    @ResponseBody
    public ServerResponse<Boolean> queryOrderPayStatus(HttpServletRequest httpServletRequest, Long orderNo, HttpServletRequest requset){
    //    User user = (User)session.getAttribute(Const.CURRENT_USER);
